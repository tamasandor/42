#ifndef SERVER_CLIENT_EVENT_CONTEXT_HPP_
#define SERVER_CLIENT_EVENT_CONTEXT_HPP_
...
public:
	ClientEventContext() : _io_handler(NULL), _io_context(NULL), _fd(NULL), _timer(NULL) {}
	~ClientEventContext() {
		delete _io_handler;
		delete _io_context;
		delete _fd;
...
#endif // SERVER_CLIENT_EVENT_CONTEXT_HPP_